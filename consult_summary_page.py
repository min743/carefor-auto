...
.back{display:inline-block;margin:0 0 12px;background:#eef2f9;color:#2f5496;padding:7px 15px;border-radius:16px;text-decoration:none;font-size:14px;font-weight:bold}
.note{font-size:13px;color:#777;margin-top:16px;line-height:1.8}
