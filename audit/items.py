...
ITEMS = [
    ...
    {"no": 8,  "name": "직원권익향상",         "method": "auto",   "loc": "8-1-1 복지(포상) 제공대장",     "criteria": "①5대보험 가입(수기·서류) ②평가 가산금 처우개선 사용(수기) ③분기 1회 이상 복지(포상): 8-1-1 대장 매월 입력 + 노션 생일쿠폰 발송내역(월별 생일자, cc/ccc)과 직원명단 대조", "impl": False},
